...
target_ep = 'axb6ef1ye7l5s-ats.iot.us-west-2.amazonaws.com'
thing_name = 'ratchet'
cert_filepath = './device-crt-and-keys/certificate.pem'
private_key_filepath = './device-crt-and-keys/privateKey.pem'
